...
export const Header = () => {
    return (
        <Hero>
            ...
            <HeroFooter>
                <HeroFooterLeft>
                    <TitleTextHeroFooter>closing in</TitleTextHeroFooter>
                </HeroFooterLeft>
                <HeroFooterRight>
